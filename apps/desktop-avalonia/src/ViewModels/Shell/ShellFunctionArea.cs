...
public static class ShellFunctionAreas
{
    ...
    public static ShellFunctionArea Integration { get; } =
        new(IntegrationId, "自动化集成", "Agents · Msfx", "AudioWaveform");

    public static string TraceabilityName => Traceability.Name;
    public static string IntegrationName => Integration.Name;
    public static string TraceabilityIcon => Traceability.Icon;
    public static string IntegrationIcon => Integration.Icon;

    public static IReadOnlyList<ShellFunctionArea> All { get; } = [Traceability, Integration];
