...
public sealed class AutomationConfigDto
{
    public AutomationAhkOptionsDto Ahk { get; set; } = new();
    public AutomationAgentOptionsDto Agent { get; set; } = new();
}
...
public sealed class AutomationAgentOptionsDto
{
...
public readonly record struct AutomationCommandResult(bool Ok, string Message, bool SuppressToast = false);
