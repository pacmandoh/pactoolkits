...
跨模块说明放在 `docs/`；各子项目 README / `docs/` 放模块细节。
...
| [agents.md](./architecture/agents.md)                   | Agents：Host + Modules、进程与控制文件 |
| [desktop-state.md](./architecture/desktop-state.md)     | Desktop 连接 / 页面可用性 / 空态三层   |
...
- [Scripts](../scripts/docs/tooling.md)
